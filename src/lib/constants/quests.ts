...
export const QUEST_TYPE_MAP: QuestTypeMapType = {
  ...
  "Children of the Sun": QuestType.P2P,
  ...
  "Death on the Isle": QuestType.P2P,
  "Death Plateau": QuestType.P2P,
  "Death to the Dorgeshuun": QuestType.P2P,
  "Defender of Varrock": QuestType.P2P,
  ...
  "Ethically Acquired Antiquities": QuestType.P2P,
  ...
  "The Heart of Darkness": QuestType.P2P,
  ...
  "The Ribbiting Tale of a Lily Pad Labour Dispute": QuestType.P2P,
  ...
  "Twilight's Promise": QuestType.P2P,
  ...
  "Barbarian Training": QuestType.MINI,
