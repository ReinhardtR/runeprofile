...
export const COLLECTION_LOG_TABS: CollectionLogTab[] = [
  {
    ...
    pages: [
      ...
      {
        name: "The Mad Angel",
        items: [34042, 34027, 34033, 21726, 34030],
        aliases: ["mad angel"],
      },
      {
        name: "Maggot King",
      ...
      {
        name: "Sarachnis",
        items: [23495, 23525, 23517, 23528, 33133],
    ...
    pages: [
      ...
      },
      {
        ...
        items: [
          ...
          6665, 6666, 11037, 11902, 34401, 20727, 8901, 21646, 21643, 21637,
          6809, 10589, 11286, 4119, 4121, 4123, 4125, 4127, 4129, 4131, 11840,
          13265, 11908, 12004, 11235, 12002, 3140, 20849, 21028, 21009, 22804,
          22963, 22960, 22957, 22988, 22971, 22973, 22969, 4109, 4111, 4113,
          4115, 4117, 4099, 4101, 4103, 4105, 4107, 23047, 23050, 23053, 23056,
          23059, 24268, 32876, 24288, 24291, 24294, 24777, 26225, 26221, 26223,
          26227, 26229, 28583, 29084, 29455, 29806, 29889, 29892, 29895, 30957,
          31081, 31084, 31086, 31996, 31243, 31235, 33663, 33661, 34404, 34410,
          34416, 34422,
        ],
        aliases: ["slay"],
      },
      ...
      },
      {
        name: "Miscellaneous",
        items: [
          21509, 13071, 13576, 7991, 7993, 7989, 31408, 31412, 31416, 31420,
          31424, 31428, 10976, 10977, 11942, 26945, 19679, 19681, 19683, 11338,
          11335, 2366, 22100, 22103, 21918, 1249, 19707, 21838, 20439, 20436,
