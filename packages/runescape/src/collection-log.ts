...
export const COLLECTION_LOG_TABS: CollectionLogTab[] = [
  {
    ...
    pages: [
      ...
      },
      {
        ...
        aliases: ["shellbane", "gryphon", "gull"],
      },
      {
        name: "Skotizo",
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        name: "Scroll Cases",
        items: [
          30902, 30904, 30906, 30908, 30910, 30912, 30914, 30916, 30918, 30920,
          30922, 30924, 30926,
        ],
      },
    ],
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        items: [31732, 31733, 31734, 31744, 31745, 31746, 31756, 31757, 31758],
        aliases: ["barra", "trials", "barracuda", "barracuda trial"],
      },
      {
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        name: "All Pets",
        items: [
          11995, 12643, 12644, 12645, 12646, 12647, 12648, 12649, 12650, 12651,
          12652, 12653, 12655, 12703, 12816, 12921, 13071, 13177, 13178, 13179,
          13181, 13225, 13247, 13262, 13320, 13321, 13322, 13324, 19730, 20659,
      ...
      },
      {
        name: "Boat Paints",
        items: [
          32087, 32090, 32093, 32096, 32099, 32102, 32104, 32106, 32108, 32110,
          32113,
        ],
        aliases: ["boat paint"],
      },
      ...
      },
      {
        ...
        items: [
          31770, 31773, 31776, 31779, 31782, 31785, 31788, 31791, 31794, 31797,
          31800,
        ],
        aliases: ["ocean encounter"],
      },
      {
        name: "Random Events",
        items: [
      ...
      },
      {
        name: "Sea Treasures",
        items: [
          32388, 32389, 32390, 32391, 32392, 32393, 32394, 32395, 32398, 32863,
          32864, 32865, 32866, 32867, 32868, 32869, 32870,
        ],
        aliases: ["sea treasure"],
      },
      {
      ...
      },
      {
        name: "Slayer",
        items: [
          3140, 4099, 4101, 4103, 4105, 4107, 4109, 4111, 4113, 4115, 4117,
          4119, 4121, 4123, 4125, 4127, 4129, 4131, 4151, 4153, 6665, 6666,
          6809, 7975, 7976, 7977, 7978, 7979, 8901, 10589, 11037, 11235, 11286,
          11840, 11902, 11908, 12002, 12004, 13265, 20724, 20727, 20730, 20736,
          20849, 21009, 21028, 21270, 21637, 21643, 21646, 22804, 22957, 22960,
          22963, 22969, 22971, 22973, 22988, 23047, 23050, 23053, 23056, 23059,
          24268, 24288, 24291, 24294, 24777, 26221, 26223, 26225, 26227, 26229,
          28583, 29084, 29455, 29806, 29889, 29892, 29895, 30957, 31081, 31084,
          31086, 31235, 31243, 31996, 32876,
        ],
        aliases: ["slay"],
      },
      {
      ...
      },
      {
        name: "Miscellaneous",
        items: [
          1249, 2366, 6571, 7536, 7538, 7989, 7991, 7993, 9007, 9008, 9010,
          9011, 10976, 10977, 11335, 11338, 11942, 13071, 13392, 13576, 19679,
          19681, 19683, 19707, 20433, 20436, 20439, 20442, 20754, 21343, 21345,
          21392, 21509, 21649, 21838, 21918, 22100, 22103, 22374, 22875, 23522,
          23943, 23959, 24000, 24034, 24037, 24040, 24043, 24046, 25844, 25846,
          26945, 28813, 30111, 30324, 31408, 31412, 31416, 31420, 31424, 31428,
          31572,
        ],
        aliases: ["misc"],
      },
