...
export const COMBAT_ACHIEVEMENT_TASKS: CombatAchievementTask[] = [
  ...
  { index: 107, tierId: 5, name: 'Corrupted Gauntlet Speed-Chaser', description: 'Complete a Corrupted Gauntlet in less than 7 minutes and 5 seconds.', type: 'Speed', monster: 'Corrupted Hunllef' },
  { index: 108, tierId: 6, name: 'Corrupted Gauntlet Speed-Runner', description: 'Complete a Corrupted Gauntlet in less than 6 minutes and 5 seconds.', type: 'Speed', monster: 'Corrupted Hunllef' },
  ...
  { index: 117, tierId: 5, name: 'Gauntlet Speed-Chaser', description: 'Complete the Gauntlet in less than 4 minutes and 45 seconds.', type: 'Speed', monster: 'Crystalline Hunllef' },
  { index: 118, tierId: 6, name: 'Gauntlet Speed-Runner', description: 'Complete the Gauntlet in less than 3 minutes and 45 seconds.', type: 'Speed', monster: 'Crystalline Hunllef' },
  ...
  { index: 640, tierId: 6, name: 'Maggot King Speed Chaser', description: 'Complete the first 5 kills of the Maggot King within 9 minutes after entering the arena.', type: 'Speed', monster: 'Maggot King' },
