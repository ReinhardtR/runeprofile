...
When new items are added, the `apps/web/assets/item-icons.json` file needs to be updated. The file is generated by running the Dev Tool in the RuneProfile plugin.
