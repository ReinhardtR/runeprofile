/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a9e20f83b09bdc492e7d7c68daf678d7)
// Runtime types generated with workerd@1.20260721.1 2025-03-01 nodejs_compat
interface __BaseEnv_Env {
	KV: KVNamespace;
	BUCKET: R2Bucket;
	HYPERDRIVE: Hyperdrive;
	V1_RATE_LIMIT: RateLimit;
	V1_RATE_LIMIT_KEYED: RateLimit;
	V1_RATE_LIMIT_PARTNER: RateLimit;
